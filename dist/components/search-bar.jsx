export default function SearchBar({ page, onSearch, }) {
    const placeholderText = page === "messages" ? "Search for messages" : "Search for reports";
    return (<div id="search-bar" className="flex items-center justify-between bg-accent rounded-[1.75rem] p-2 h-12">
      {/* Magnifying Glass SVG */}
      <div className="flex items-center gap-5">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_2002_11811)">
            <path fillRule="evenodd" clipRule="evenodd" d="M25.4152 24.0956L30.49 29.1704L29.1704 30.49L24.0956 25.4152C23.148 26.0972 22.0055 26.5134 20.7567 26.5134C17.5772 26.5134 15 23.9362 15 20.7567C15 17.5772 17.5772 15 20.7567 15C23.9362 15 26.5134 17.5772 26.5134 20.7567C26.5134 22.0055 26.0972 23.148 25.4152 24.0956ZM20.7567 16.7713C18.5515 16.7713 16.7713 18.5515 16.7713 20.7567C16.7713 22.962 18.5515 24.7421 20.7567 24.7421C22.962 24.7421 24.7421 22.962 24.7421 20.7567C24.7421 18.5515 22.962 16.7713 20.7567 16.7713Z" fill="#030D17" fillOpacity="0.6"/>
          </g>
          <defs>
