...
const ReportsBrief = () => {
    ...
    return (<div id="reports-brief" className="">
      {reportData.map((report, index) => (<div key={index} className="border-b border-gray-200 py-4 flex justify-between items-center" onClick={() => handleClick(report.reportName)} style={{
