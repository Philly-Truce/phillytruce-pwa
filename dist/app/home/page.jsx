...
export default function Home() {
    ...
    return (<div className="w-full px-4">
      ...
      <section>
        ...
        {ListItems.map((listItem, index) => (<div key={index} className="mb-2 py-2 px-4 bg-homelistbg flex">
            <Image src={Thumbnail} width={56} height={56} alt="List item thumbnail" className="self-center"/>
