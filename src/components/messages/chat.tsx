  ...
  return (
    ...
    >
          ...
          return (
            <>
              ...
              {isLastChatbotMessage && (
                <div
                  id="chatbot-divider"
                  className="flex flex-col my-4 text-[#1C4587] text-center text-[11px] font-bold leading-[166%] tracking-[0.4px] mr-4"
                >
                  <div
                    id="end-chatbot"
      ...
      >
        ...
        >
          <g clip-path="url(#clip0_2049_10952)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <button type="submit" disabled={loadingState !== "ready"}>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_2049_10955)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
